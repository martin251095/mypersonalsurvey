 ...
 */
final class Version20190624044506 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE quiz_category ADD id INT AUTO_INCREMENT NOT NULL, ADD weight INT NOT NULL, ADD PRIMARY KEY (id)');
