        ...
        foreach ($context['_seq'] as $context["_key"] => $context["surveyanswer"]) {
            ...
            echo "
                <tr class=\"text-center\">
                    <td>";
            // line 21
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["surveyanswer"], "id", [], "any", false, false, false, 21), "html", null, true);
            echo "</td>
                    <td>";
            // line 22
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["surveyanswer"], "userFirstname", [], "any", false, false, false, 22), "html", null, true);
            echo "</td>
                    <td>";
            // line 23
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["surveyanswer"], "userLastname", [], "any", false, false, false, 23), "html", null, true);
            echo "</td>
                    <td>";
            // line 24
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["surveyanswer"], "survey", [], "any", false, false, false, 24), "title", [], "any", false, false, false, 24), "html", null, true);
            echo "</td>
                    <td>";
            // line 25
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["surveyanswer"], "score", [], "any", false, false, false, 25), "html", null, true);
            echo "</td>
                    <td>";
            // line 26
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["surveyanswer"], "total", [], "any", false, false, false, 26), "html", null, true);
            echo "</td>
                    <td>
                        <a href=\"";
            // line 28
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_surveyanswer_details", ["id" => twig_get_attribute($this->env, $this->source, $context["surveyanswer"], "id", [], "any", false, false, false, 28)]), "html", null, true);
            echo "\"
                           class=\"btn btn-primary\"><i class=\"fas fa-eye\"></i></a>
                        <a href=\"";
            // line 30
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_surveyanswer_delete", ["id" => twig_get_attribute($this->env, $this->source, $context["surveyanswer"], "id", [], "any", false, false, false, 30)]), "html", null, true);
            echo "\" onclick=\"";
        ...
        <table class=\"table table-hover\">
            ...
            {% for surveyanswer in pagination.data %}
                ...
                <tr class=\"text-center\">
                    ...
                    <td>{{ surveyanswer.userFirstname }}</td>
                    <td>{{ surveyanswer.userLastname }}</td>
                    <td>{{ surveyanswer.survey.title }}</td>
                    <td>{{ surveyanswer.score }}</td>
                    <td>{{ surveyanswer.total }}</td>
                    <td>
                        <a href=\"{{ path('admin_surveyanswer_details',{'id':surveyanswer.id}) }}\"
                           class=\"btn btn-primary\"><i class=\"fas fa-eye\"></i></a>
                        <a href=\"{{ path('admin_surveyanswer_delete',{'id':surveyanswer.id}) }}\" onclick=\"{{ confirm }}\" class=\"btn btn-danger\"><i
                                    class=\"fas fa-trash\"></i></a>
                    </td>
                </tr>
            {% endfor %}
